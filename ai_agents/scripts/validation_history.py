...
class ValidationHistoryManager:
    ...
    def append_entry(self, entry: ValidationHistoryEntry) -> None:
...
def append_validation_entry(
    ...
    """
    Factory function to create and append a validation entry.
    ...
    Returns:
        None (entry is created but not returned to avoid type inconsistency)
    """
    ...
    # append_entry() returns None, but the function signature shows it returns ValidationHistoryEntry
    return None

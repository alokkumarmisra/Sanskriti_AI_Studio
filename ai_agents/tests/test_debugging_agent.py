...
sys.path.insert(0, os.path.join(PROJECT_ROOT, 'ai_agents', 'scripts'))
...
class TestFailureClassification:
    ...
    def test_test_failure_classification(self):
        ...
        from scripts.debugger_agent import classify_failure_type
...
class TestSeverityDetection:
    ...
    def test_critical_severity(self):
        ...
        from scripts.debugger_agent import detect_severity
...
class TestRootCauseExtraction:
    ...
    def test_database_connection_root_cause(self):
        ...
        from scripts.debugger_agent import extract_root_cause
...
class TestAffectedFilesIdentification:
    ...
    def test_extract_files_from_stack_trace(self):
        ...
        from scripts.debugger_agent import analyze_affected_files
...
class TestFixPlanGeneration:
    ...
    def test_fix_plan_created_for_test_failure(self):
        ...
        from scripts.debugger_agent import build_fix_plan
...
class TestRetryLimitEnforcement:
    ...
    def test_retry_recommendation_for_medium_severity(self):
        ...
        from scripts.debugger_agent import MAX_DEBUG_RETRIES
...
class TestDebuggingRequestProcessing:
    ...
    @patch('scripts.debugger_agent.chat_with_coding_model')
    def test_successful_debugging_flow(self, mock_chat):
        """Test successful debugging flow with model available."""
        from scripts.debugger_agent import process_debugging_request
...
class TestEscalationLogic:
    ...
    def test_escalation_after_max_retries(self):
        ...
        from scripts.debugger_agent import MAX_DEBUG_RETRIES, process_debugging_request
